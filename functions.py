    ...
    while running:
        ...
        while sunglasses_check:
            ...
            if level.structure[random_number_6][random_number_5] != "1":
                sunglasses_position = sunglasses.get_rect(
                    topleft=(sunglasses_random_x_position, sunglasses_random_y_position))
                # End the loops
                sunglasses_check = 0
